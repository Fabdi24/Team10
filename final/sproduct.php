    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-details">
            ...
            if (isset($_POST['Submit'])) {
                ...
                $product = mysqli_query($conn, "SELECT * FROM products WHERE id = '0'");

                $select = mysqli_query($conn, "SELECT * FROM user WHERE user_id ='$user_id'");
                $sql = "INSERT INTO user (user_orders) VALUES (`$product`)";
            ...
            <span>CLOUD GAMING COMPATIBLE With the reality of playing AAA versions on any screen, having the controller connected to your device provides a convenient form factor and portable enough to play anywhere</span>
        </div>
    </section>
